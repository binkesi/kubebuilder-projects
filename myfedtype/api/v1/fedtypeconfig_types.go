...
// FedTypeConfigSpec defines the desired state of FedTypeConfig
type FedTypeConfigSpec struct {
	...
	FedType APIResource `json:"fedType"`
...
type FedTypeConfigStatus struct {
...
// +kubebuilder:resource:path=fedtypeconfigs,shortName=ftc
...
//   clusters.
type FedTypeConfig struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec FedTypeConfigSpec `json:"spec"`
	// +optional
	Status FedTypeConfigStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// FederatedTypeConfigList contains a list of FederatedTypeConfig
type FedTypeConfigList struct {
	metav1.TypeMeta `json:",inline"`
	// +optional
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []FedTypeConfig `json:"items"`
}

func init() {
	SchemeBuilder.Register(&FedTypeConfig{}, &FedTypeConfigList{})
}

func SetFederatedTypeConfigDefaults(obj *FedTypeConfig) {
	...
	setStringDefault(&obj.Spec.FedType.PluralName, PluralName(obj.Spec.FedType.Kind))
	if obj.Spec.StatusType != nil {
		setStringDefault(&obj.Spec.StatusType.PluralName, PluralName(obj.Spec.StatusType.Kind))
		setStringDefault(&obj.Spec.StatusType.Group, obj.Spec.FedType.Group)
		setStringDefault(&obj.Spec.StatusType.Version, obj.Spec.FedType.Version)
	}
}
...
func (f *FedTypeConfig) GetObjectMeta() metav1.ObjectMeta {
	return f.ObjectMeta
}

func (f *FedTypeConfig) GetTargetType() metav1.APIResource {
...
func (f *FedTypeConfig) GetNamespaced() bool {
	return f.Spec.TargetType.Namespaced()
}

func (f *FedTypeConfig) GetPropagationEnabled() bool {
	return f.Spec.Propagation == PropagationEnabled
}

func (f *FedTypeConfig) GetFedType() metav1.APIResource {
	return apiResourceToMeta(f.Spec.FedType, f.GetFedNamespaced())
}
...
func (f *FedTypeConfig) GetStatusType() *metav1.APIResource {
...
func (f *FedTypeConfig) GetStatusEnabled() bool {
...
func (f *FedTypeConfig) GetFedNamespaced() bool {
...
func (f *FedTypeConfig) IsNamespace() bool {
